      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURE_DATA.map((feature, idx) => (
            <div key={idx} className="group relative overflow-hidden glass p-10 rounded-[40px] border-white/5 hover:border-brand-gold/30 transition-all hover:-translate-y-2 duration-500 cursor-pointer">
              ...
              <div className="relative z-10 space-y-8">
                <div className="w-14 h-14 glass rounded-2xl flex items-center justify-center text-white/40 group-hover:text-brand-gold transition-all duration-500 border-white/5 shadow-2xl">
                  {feature.icon}
                </div>
