...
export const Dashboard: React.FC = () => {
  return (
    <section className="py-40 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-[20%] right-[-10%] w-[400px] h-[400px] bg-blue-600/10 blur-[150px] rounded-full -z-10"></div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between space-y-12">
            <div className="space-y-6">
               <div className="w-12 h-12 glass rounded-2xl flex items-center justify-center border-white/10 text-blue-400">
                  <TrendingUp size={24} />
               </div>
            ...
            <div className="grid grid-cols-2 gap-4">
               ...
               <div className="glass p-6 rounded-3xl border-white/5">
                  <PieChart size={18} className="text-purple-400 mb-4" />
               ...
               <div className="bg-[#080808] rounded-[42px] h-full w-full p-8 md:p-12 border border-white/5">
                  <div className="flex justify-between items-center mb-12">
                     ...
                     <div className="flex gap-2">
                        <div className="w-8 h-8 glass rounded-lg flex items-center justify-center cursor-pointer hover:bg-white/5">
